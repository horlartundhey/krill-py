...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="index.html"><img src="{{url('public/panel/assets/img/krillpay-logo.png')}}" class="main-logo" alt="logo"></a>
        
        <a class="logo-icon mobile-logo icon-dark active" href="index.html"><img src="{{url('public/panel/assets/img/krillpay-logo.png')}}" class="logo-icon dark-theme" alt="logo"></a>
    </div>
    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="{{url('public/panel/assets//img/faces/6.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item @if(Request::segment(2) == 'home') active @endif" href="{{url('admin/home')}}">Home</a></li>

                    <li><a class="slide-item @if(Request::segment(2) == 'about') active @endif" href="{{url('admin/about')}}">About</a></li>
                    <li><a class="slide-item @if(Request::segment(2) == 'faq') active @endif" href="{{url('admin/faq')}}">FAQ</a></li>
                    <li><a class="slide-item @if(Request::segment(2) == 'contact') active @endif" href="{{url('admin/contact')}}">Contact</a></li>
